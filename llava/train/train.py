...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        if 'mpt' in model_args.model_name_or_path:
            ...
            model_type = _read_model_type(model_args.model_name_or_path)
            is_qwen3_moe = model_type == "qwen3_moe" or "qwen3-moe" in model_args.model_name_or_path.lower()
            # is_qwen3 = model_type == "qwen3" or "qwen3" in model_args.model_name_or_path.lower()
            if is_qwen3_moe:
                ...
                try:
                    ...
                    rank0_print("Qwen3 MoE sparse block not available; skipping ZeRO-3 leaf module setup.")
            else:
    ...
    # IMPORTANT: Initialize vision_modules BEFORE ecg_modules
    # because mm_hidden_size is set from vision_tower.hidden_size
    if model_args.vision_tower is not None:
    ...
    # Initialize ECG modules AFTER vision modules (requires mm_hidden_size)
